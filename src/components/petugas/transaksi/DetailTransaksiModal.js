          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400">
                {transaction.subItems.length} jenis sampah
              </p>
            </div>
          </div>
          <button
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[9px] font-mono text-slate-400 bg-slate-100 dark:bg-slate-800/80 px-1.5 py-0.5 rounded mt-0.5 inline-block">
                    #{item.id || item.id_setor_detail || item.detail_id || item.id_detail || '—'}
                  </p>
              ...
              <span
                className={`text-[9px] px-2 py-1 rounded-lg font-semibold ring-1 ${
                  item.tipe_setoran === "COMMUNITY"
